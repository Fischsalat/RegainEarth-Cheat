...
{
	unsigned char                                      UnknownData_2G2J[0xAC];                                    // 0x0000(0x00AC) MISSED OFFSET (PADDING)
...
struct FBehaviorInfo
{
	...
	unsigned char                                      UnknownData_U7LA[0x18];                                    // 0x0008(0x0018) MISSED OFFSET (PADDING)
...
struct FActiveGizmo
{
	unsigned char                                      UnknownData_17Y2[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FInputRayHit
{
	unsigned char                                      UnknownData_N9KQ[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
