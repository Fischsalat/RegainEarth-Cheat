...
// 0x014D (FullSize[0x03AD] - InheritedSize[0x0260])
...
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_Frame.WB_Frame_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_WB_Frame(int EntryPoint);
};
