...
struct FHairGroupInfoWithVisibility : public FHairGroupInfo
{
	...
	unsigned char                                      UnknownData_27PQ[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FHairShadowSettings
{
	...
	unsigned char                                      UnknownData_7B7G[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FHairSolverSettings
{
	...
	unsigned char                                      UnknownData_N1XA[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairInterpolationSettings
{
	...
	unsigned char                                      UnknownData_WP5Y[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairLODSettings
{
	...
	unsigned char                                      UnknownData_W7WL[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCardsClusterSettings
{
	...
	unsigned char                                      UnknownData_AMZ1[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCardsGeometrySettings
{
	...
	unsigned char                                      UnknownData_VTHQ[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O6L8[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupCardsTextures
{
	...
	unsigned char                                      UnknownData_XLZQ[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FHairGroupsRendering
{
	...
	unsigned char                                      UnknownData_GH17[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FHairStretchConstraint
{
	...
	unsigned char                                      UnknownData_A2J9[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GCO2[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairCollisionConstraint
{
	...
	unsigned char                                      UnknownData_QA90[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairBendConstraint
{
	...
	unsigned char                                      UnknownData_I644[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_770Z[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairStrandsParameters
{
	...
	unsigned char                                      UnknownData_3XLG[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupsPhysics
{
	...
	unsigned char                                      UnknownData_G9CP[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupDesc
{
	...
	unsigned char                                      UnknownData_YNXH[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D9YO[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0C16[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WZNS[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C9HN[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZYR3[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Z6YY[0x2];                                     // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FFollicleMaskOptions
{
	...
	unsigned char                                      UnknownData_KENA[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
...
struct FHairGroupsCardsSourceDescription
{
	...
	unsigned char                                      UnknownData_6P9Z[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	bool                                               bOverrideGuides;                                           // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_VA4J[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              HairToGuideDensity;                                        // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
