...
// WidgetBlueprintGeneratedClass W_WarningAndConfirmFrameButton.W_WarningAndConfirmFrameButton_C
// 0x007E (FullSize[0x0328] - InheritedSize[0x02AA])
class UW_WarningAndConfirmFrameButton_C : public UW_ParentButtons_C
{
public:
	unsigned char                                      UnknownData_74QZ[0x6];                                     // 0x02AA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass W_WarningAndConfirmFrameButton.W_WarningAndConfirmFrameButton_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_W_WarningAndConfirmFrameButton(int EntryPoint);
