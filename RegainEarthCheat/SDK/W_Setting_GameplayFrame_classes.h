...
// WidgetBlueprintGeneratedClass W_Setting_GameplayFrame.W_Setting_GameplayFrame_C
// 0x0069 (FullSize[0x02F9] - InheritedSize[0x0290])
...
public:
	...
	class UW_SwitchButton_C*                           W_BloodSwitch;                                             // 0x02B8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UBP_Save_Gameplay_Settings_C*                SaveSettings;                                              // 0x02E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSSettings_Gameplay                         SettingsBufer;                                             // 0x02E8(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                               ConstructorRunAlready;                                     // 0x02F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass W_Setting_GameplayFrame.W_Setting_GameplayFrame_C");
		return ptr;
	}
	...
	bool IsSettingsEqual(const struct FSSettings_Gameplay& A, const struct FSSettings_Gameplay& B);
	void Save_SaveSettings();
	void ApplySettings(const struct FSSettings_Gameplay& SSettings_Sounds);
	void RestoreValues(const struct FSSettings_Gameplay& SSettings_Sounds);
	void Construct();
	...
	void BndEvt__W_BloodSwitch_K2Node_ComponentBoundEvent_2_OnChangeValue__DelegateSignature(const struct FName& NewValue);
	void ExecuteUbergraph_W_Setting_GameplayFrame(int EntryPoint);
};
