...
class ABP_Hook_C : public ABP_BaseHook_C
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0250(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	bool                                               bSnapToCargo;                                              // 0x0258(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	unsigned char                                      UnknownData_TP5E[0x3];                                     // 0x0259(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Hook.BP_Hook_C");
		return ptr;
	}
	...
	void HookAction();
	void UnhookAction();
	void ExecuteUbergraph_BP_Hook(int EntryPoint);
};
