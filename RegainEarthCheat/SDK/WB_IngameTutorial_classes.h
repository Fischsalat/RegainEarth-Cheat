...
public:
	...
	class UImage*                                      BackgroundImg;                                             // 0x0278(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class USizeBox*                                    SB_Row1_Button1_2;                                         // 0x02C8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UW_KeyButtonSimpleDisplay_C*                 W_KeyButtonSimpleDisplayRow1Button1_2;                     // 0x0340(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	unsigned char                                      UnknownData_SHIX[0x2];                                     // 0x036A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_IngameTutorial.WB_IngameTutorial_C");
		return ptr;
	}



	void CheckRows(const struct FS_IngameTutorial& In_Row_1, const struct FS_IngameTutorial& In_Row_2);
	...
	void DisplayIngameTutorial(float DisplayTime, const struct FS_IngameTutorial& Row1, const struct FS_IngameTutorial& Row2);
	void Construct();
	void RemoveTutorial();
	void OnInitialized();
	void ExecuteUbergraph_WB_IngameTutorial(int EntryPoint);
};
