...
{
public:
	unsigned char                                      UnknownData_URYA[0x48];                                    // 0x0028(0x0048) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_BU6X[0x28];                                    // 0x0028(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AZRO[0x10];                                    // 0x00B0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RXV9[0x78];                                    // 0x0028(0x0078) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RDF8[0x180];                                   // 0x00B0(0x0180) MISSED OFFSET (PADDING)
...
template<typename T>
	...
	{
		// return nullptr;                   index may be wrong
...
public:
	...
	unsigned char                                      pad_VDGZ9LP2XW[0x01];                                      // 0x00B7(0x0001) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_VMDE42DAQU[0x02];                                      // 0x00BE(0x0002) NOT AUTO-GENERATED PROPERTY
	...
	unsigned char                                      pad_S5MB3CWBGU[0x04];                                      // 0x00D4(0x0004) NOT AUTO-GENERATED PROPERTY
...
{
public:
	unsigned char                                      UnknownData_A0L9[0x10];                                    // 0x00E0(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6HT7[0x80];                                    // 0x0230(0x0080) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_LPHB[0xB8];                                    // 0x0028(0x00B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_CDDS[0x30];                                    // 0x0030(0x0030) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_RKNI[0x1B8];                                   // 0x0230(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_J1SK[0xC8];                                    // 0x0028(0x00C8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3ZC4[0x1B8];                                   // 0x00E0(0x01B8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MWO9[0xA0];                                    // 0x0028(0x00A0) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_FZEB[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_9J5G[0x40];                                    // 0x0030(0x0040) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_KM5G[0x10];                                    // 0x0070(0x0010) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DWM4[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_Q3DI[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_3W3I[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_IAGH[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_EYVY[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_AI5N[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_8BTI[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_PH86[0x28];                                    // 0x0070(0x0028) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6LHH[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_MHOT[0x20];                                    // 0x0070(0x0020) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_SGFS[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_5628[0x8];                                     // 0x0070(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DXBW[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
