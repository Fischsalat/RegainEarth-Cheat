...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class TimeManagement.GenlockedCustomTimeStep");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_8TFC[0x27];                                    // 0x0031(0x0027) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class TimeManagement.GenlockedTimecodeProvider");
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_FLZ2[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
