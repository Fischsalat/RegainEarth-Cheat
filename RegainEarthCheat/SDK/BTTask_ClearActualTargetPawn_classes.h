...
// BlueprintGeneratedClass BTTask_ClearActualTargetPawn.BTTask_ClearActualTargetPawn_C
...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BTTask_ClearActualTargetPawn.BTTask_ClearActualTargetPawn_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BTTask_ClearActualTargetPawn(int EntryPoint);
};
