...
// WidgetBlueprintGeneratedClass WB_ShineSmall.WB_ShineSmall_C
// 0x0040 (FullSize[0x02A0] - InheritedSize[0x0260])
class UWB_ShineSmall_C : public UUserWidget
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x0260(0x0008) (ZeroConstructor, Transient, DuplicateTransient, UObjectWrapper)
	class UWidgetAnimation*                            Opacityloop;                                               // 0x0268(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	class UWidgetAnimation*                            Img;                                                       // 0x0278(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData, RepSkip, NoDestructor, HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass WB_ShineSmall.WB_ShineSmall_C");
		return ptr;
	}
	...
	void Construct();
	void ExecuteUbergraph_WB_ShineSmall(int EntryPoint);
};
