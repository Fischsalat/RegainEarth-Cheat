...
struct UW_MainFrameButton_C_OnKeyUp_Params
{
...
struct UW_MainFrameButton_C_SetCustomFocus_Params
{
	bool                                               IsSuccess;                                                 // (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function W_MainFrameButton.W_MainFrameButton_C.SetHovered
struct UW_MainFrameButton_C_SetHovered_Params
{
...
struct UW_MainFrameButton_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                              // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// Function W_MainFrameButton.W_MainFrameButton_C.Tick
struct UW_MainFrameButton_C_Tick_Params
{
	struct FGeometry                                   MyGeometry;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
...
struct UW_MainFrameButton_C_BndEvt__Button_0_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function W_MainFrameButton.W_MainFrameButton_C.Accept
struct UW_MainFrameButton_C_Accept_Params
{
};

// Function W_MainFrameButton.W_MainFrameButton_C.ExecuteUbergraph_W_MainFrameButton
struct UW_MainFrameButton_C_ExecuteUbergraph_W_MainFrameButton_Params
{
